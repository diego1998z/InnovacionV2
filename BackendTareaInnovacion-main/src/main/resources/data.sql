-- ═══════════════════════════════════════════════════
-- CreditAI — Script de inicialización PostgreSQL
-- ═══════════════════════════════════════════════════

-- Crear la base de datos (ejecutar como superusuario)
-- CREATE DATABASE credit_ai_db;

-- ── Datos iniciales ─────────────────────────────────
-- Production users must be created through the register endpoint or an
-- environment-specific migration, never with deployable default credentials.
...
-- ── Historial financiero de prueba ──────────────────

-- Carlos Mendoza — excelente historial
